...
import RoomsList from '../../saleRooms/components/RoomsList';

import '../../styles.css';



class BookingUpdateSummary extends React.Component {
...
const mapStateToProps = (state) => ({
    ...
    rooms: selectorsSaleRooms.getSummaryRooms(state)
...
export default connect (mapStateToProps, mapDispatchToProps)(BookingUpdateSummary);